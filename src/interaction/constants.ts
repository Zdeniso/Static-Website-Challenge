...
export const ID_CANCEL_NEW_PROJECT_BUTTON : string = "new-project-cancel-button";
...
export const ID_CANCEL_BUTTON: string = "cancel-button";
...
// User's Page Error
export const ID_ERROR_DIALOG: string = "error-user-dialog-area";
export const ID_GOTIT_BUTTON: string = "button_gotit";